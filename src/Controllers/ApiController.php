...
abstract class ApiController {
    ...
    const TRANSACTION_TYPE = array("201" => "Customer Login", "202" => "Registration", "203" => "Pool Registration", "204" => "Email verification", "205" => "Wallet Creation", "206" => "Wallet Balance Fetch", "301" => "Membership Invoice Creation", "302" => "Pool Purchase Invoice Creation","401"=>"Join Tree");
